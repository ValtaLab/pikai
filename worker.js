...
function generatePage({ news = [], tools = [], videos = [], blogPosts = [], updatedAt, summarizedNews = [], summarizedAt = null }) {
  ...
  <g transform="translate(461.09215017064844, 117) scale(0.20477815699658702)">
